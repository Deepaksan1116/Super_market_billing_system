...
namespace Demo_super_market
{
    public  class EmployeeRepositry
    {
        ...
        public void Add_employee(Employee es)
        {
            ...
            content = es.Employee_id + "|" + es.Employee_name + "|" + es.Phone_number + "|" + es.Employee_type + "|"+es.Email_id+"|"+es.Current_status +"|"+ es.Password+"|"+es.Address.House_no + "|" + es.Address.Street_name + "|" + es.Address.Village_name + "|" + es.Address.Taluk_name + "|" + es.Address.Pincode + "|" + es.Address.District;
